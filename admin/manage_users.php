    ...
    <div class="flex min-h-screen">
        <aside class="w-64 bg-gray-900 text-white fixed h-full overflow-y-auto">
            ...
            <nav class="p-4">
                <ul class="space-y-1">
                    ...
                    <?php endif; ?>
                    <li><a href="manage_users.php" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-gray-700 text-white"><i class="ph ph-users w-5"></i> Utilisateurs</a></li>
        ...
        <main class="flex-1 ml-64 p-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
                <h2 class="text-lg font-semibold mb-4"><i class="ph ph-user-plus text-primary mr-2"></i> Ajouter un utilisateur</h2>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <h2 class="text-lg font-semibold p-5 border-b border-gray-100"><i class="ph ph-list-bullets mr-2"></i> Utilisateurs existants</h2>
