                    ...
                    <div>
                        ...
                        <ul class="space-y-1">
                            ...
                            <li class="flex items-center justify-between bg-gray-50 px-3 py-2 rounded-lg">
                                <span><i class="fas fa-file text-primary mr-2"></i><?= htmlspecialchars($file['file_name']) ?></span>
                                <a href="delete_file.php?id=<?= $file['id_file'] ?>&post=<?= $post_id ?>&csrf_token=<?= csrf_token() ?>" class="text-red-500 hover:text-red-700" onclick="return confirm('Supprimer ce fichier ?');"><i class="fas fa-times"></i></a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
