        ...
        <div class="flex flex-col lg:flex-row gap-8">
            <div class="flex-1">
                        ...
                        <div class="flex flex-col sm:flex-row">
                            ...
                            <div class="p-6 flex-1">
                                ...
                                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-500 mb-3">
                                    <span><i class="fas fa-user"></i> <?= htmlspecialchars($post['author_name'] ?? 'Anonyme') ?></span>
                                ...
                                <div class="flex items-center gap-4 text-sm">
                                    ...
                                    <span class="text-gray-400"><i class="fas fa-heart"></i> <?= $post['likes_count'] ?? 0 ?></span>
                                    <span class="text-gray-400"><i class="fas fa-comments"></i> <?= $post['comments_count'] ?? 0 ?></span>
                                </div>
                            </div>
                        </div>
                    </article>
                ...
                <div class="text-center py-16 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <a href="index.php" class="text-primary hover:underline mt-2 inline-block"><i class="fas fa-arrow-left"></i> Retour à l'accueil</a>
                </div>
                <?php endif; ?>
            </div>
