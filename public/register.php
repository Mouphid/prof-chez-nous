...
<body class="min-h-screen bg-gradient-to-br from-primary to-indigo-400 flex items-center justify-center p-4 font-sans">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl p-10">
        ...
        <form method="post" class="space-y-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1"><i class="ph ph-user mr-1"></i> Nom complet</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1"><i class="ph ph-envelope mr-1"></i> Email</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1"><i class="ph ph-lock mr-1"></i> Mot de passe</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1"><i class="ph ph-lock mr-1"></i> Confirmer le mot de passe</label>
