...
<div class="relative overflow-hidden bg-cover bg-center py-16" style="background-image: url('<?= BASE_URL ?>img/bg/banner-contact.jpg');">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                ...
                <form method="post" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="contact_name" class="block text-sm font-medium text-gray-700 mb-1"><i class="ph ph-user text-primary"></i> Nom complet</label>
                            <input type="text" id="contact_name" name="name" required placeholder="Votre nom" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                        <div>
                            <label for="contact_email" class="block text-sm font-medium text-gray-700 mb-1"><i class="ph ph-envelope text-primary"></i> Email</label>
                            <input type="email" id="contact_email" name="email" required placeholder="votre@email.com" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                    </div>
                    <div>
                        <label for="contact_subject" class="block text-sm font-medium text-gray-700 mb-1"><i class="ph ph-tag text-primary"></i> Sujet</label>
                        <select id="contact_subject" name="subject" required class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-primary">
                    ...
                    <div>
                        <label for="contact_message" class="block text-sm font-medium text-gray-700 mb-1"><i class="ph ph-chat text-primary"></i> Message</label>
                        <textarea id="contact_message" name="message" rows="6" required placeholder="Votre message..." class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-primary"></textarea>
                    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="#" class="w-10 h-10 bg-gray-100 hover:bg-indigo-100 hover:text-primary rounded-lg flex items-center justify-center transition text-gray-600"><i class="ph ph-x-logo"></i></a>
                    ...
                    <a href="#" class="w-10 h-10 bg-gray-100 hover:bg-indigo-100 hover:text-primary rounded-lg flex items-center justify-center transition text-gray-600"><i class="ph ph-linkedin-logo"></i></a>
                </div>
            </div>
        </div>
    </div>
