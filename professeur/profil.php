            ...
            <div class="container">
                <div class="profile-intro">
                    <div class="profile-photo-lg">
                        <i class="ph ph-user-graduate"></i>
                    </div>
                    <div class="profile-info">
                        <h2><?= htmlspecialchars($admin['name'] ?? 'Prof. Professeur') ?></h2>
                        <p class="title-line"><i class="ph ph-bank"></i> Professeur - Université de Cotonou</p>
            ...
            <div class="container">
                <div class="profile-grid">
                    <div class="profile-main">
                        ...
                        <div class="profile-card">
                            <h3><i class="ph ph-magnifying-glass"></i> Domaines de recherche</h3>
                            <div class="tags">
                                <?php
                        ...
                        <div class="profile-card">
                            <h3><i class="ph ph-award"></i> Parcours</h3>
                            <div class="timeline">
                    ...
                    <div class="profile-sidebar">
                        <div class="info-card">
                            <h3><i class="ph ph-info"></i> Statistiques</h3>
                            <ul class="info-list">
                                <li><i class="ph ph-book"></i> <strong>Articles:</strong> <?= $total_posts ?></li>
                                <li><i class="ph ph-chats"></i> <strong>Commentaires:</strong> <?= $total_comments ?></li>
                                <li><i class="ph ph-heart"></i> <strong>Likes:</strong> <?= $total_likes ?></li>
                                <li><i class="ph ph-users"></i> <strong>Utilisateurs:</strong> <?= $total_users ?></li>
                            </ul>
                        </div>
                        ...
                        <div class="info-card">
                            ...
                            <ul class="info-list">
                                ...
                                while ($cat = $cats->fetch()):
                                ?>
                                <li><i class="ph ph-folder-open"></i> <?= htmlspecialchars($cat['name']) ?> (<?= $cat['total'] ?>)</li>
                                <?php endwhile; ?>
                            </ul>
                        </div>

                        <div class="info-card">
                            <h3><i class="ph ph-graduation-cap"></i>Formation</h3>
                            <div class="edu-item">
                                <h4>Doctorat en Littérature</h4>
