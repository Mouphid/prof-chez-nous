    ...
    <footer class="bg-gray-900 text-gray-300 mt-12">
        <div class="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h4 class="text-white font-bold text-lg mb-3"><i class="ph ph-graduation-cap text-indigo-400"></i> Joie Enseignante</h4>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><i class="ph ph-envelope mr-2"></i> contact@joieenseignante.com</li>
                    <li><i class="ph ph-phone mr-2"></i> +229 XX XX XX XX</li>
                </ul>
            </div>
            <div>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="#" class="w-9 h-9 bg-gray-700 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition" title="Twitter"><i class="ph ph-twitter-logo"></i></a>
                    ...
                    <a href="#" class="w-9 h-9 bg-gray-700 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition" title="LinkedIn"><i class="ph ph-linkedin-logo-in"></i></a>
                </div>
            </div>
        </div>
        <div class="border-t border-gray-700 py-6">
            <p class="text-center text-sm text-gray-500">
                &copy; <?= date('Y') ?> Joie Enseignante. Tous droits réservés. | Développé avec <i class="ph ph-heart text-red-500"></i>
            </p>
        </div>
    </footer>
</body>
